...
function Shop() {
  ...
  const paymentHandler = async (data) => {
    ...
    try {
      const response = await fetch("https://booknest-2-04op.onrender.com/order", {
        method: "POST",
        headers: {
      ...
      const options = {
        ...
        handler: async function (response) {
          ...
          try {
            const validateResponse = await fetch("https://booknest-2-04op.onrender.com/validate", {
              method: "POST",
              headers: {
                "Content-Type": "application/json",
              },
            ...
            if (validateResponse.ok && (jsonResponse?.valid || jsonResponse?.success || jsonResponse)) {
              try {
                ...
                await axios.post("https://booknest-2-04op.onrender.com/product/order", completedOrderInfo);
  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      const res = await axios.post("https://booknest-2-04op.onrender.com/product/order", orderInfo);
      if (res.data) {
