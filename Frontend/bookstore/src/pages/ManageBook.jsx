...
const ManageBook = () => {
  ...
  const fetchBooks = async () => {
    try {
      const res = await axios.get("https://booknest-2-04op.onrender.com/book/get");
  ...
  const deleteBook = async (id) => {
    ...
    try {
      await axios.delete(`https://booknest-2-04op.onrender.com/book/delete/${id}`);
  ...
  const updateBook = async (e) => {
    ...
    try {
      await axios.put(
        `https://booknest-2-04op.onrender.com/book/update/${editingBook}`,
        formData
      );
      fetchBooks();
