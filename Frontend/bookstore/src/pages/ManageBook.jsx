...
const ManageBook = () => {
  ...
  const fetchBooks = async () => {
    try {
      const res = await axios.get("https://booknest-3-zgsw.onrender.com/book/get");
  ...
  const deleteBook = async (id) => {
    ...
    try {
      await axios.delete(`https://booknest-3-zgsw.onrender.com/book/delete/${id}`);
  ...
  const updateBook = async (e) => {
    ...
    try {
      await axios.put(
        `https://booknest-3-zgsw.onrender.com/book/update/${editingBook}`,
        formData
      );
      fetchBooks();
