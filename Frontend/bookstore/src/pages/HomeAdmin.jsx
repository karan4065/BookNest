...
export default function HomeAdmin() {
  ...
  useEffect(() => {
    const fetchStats = async () => {
      try {
        const booksRes = await axios.get("https://booknest-kymy.onrender.com/book/countbooks");
        const totalBooks = booksRes.data.length;

        const ordersRes = await axios.get("https://booknest-kymy.onrender.com/product/orders");
