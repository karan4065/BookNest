...
export default function AdmOrders() {
  ...
  const fetchOrders = async () => {
    setLoading(true);
    try {
      const res = await axios.get("https://booknest-kymy.onrender.com/product/orders");
  ...
  const updateStatus = async (order) => {
    ...
    try {
      await axios.patch(`https://booknest-kymy.onrender.com/product/orders/${id}`, {
        status: newStatus,
      });
  ...
  const acceptCancellation = async (order) => {
    ...
    try {
      await axios.delete(`https://booknest-kymy.onrender.com/product/orders/${id}`);
